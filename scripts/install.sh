...
#
# Ablauf (siehe main am Dateiende):
#   Host-System      → check_host_prerequisites, install_host_packages,
#                      configure_input_group, configure_ydotool_service
#   Python-Runtime   → setup_python_runtime
#   systemd-user     → install_app_service
#   Abschluss        → print_summary
set -euo pipefail
...
# ─── Host-System: Voraussetzungen prüfen ─────────────────────────────────────
...
# ─── Host-System: apt-Pakete installieren ────────────────────────────────────
...
# ─── Python-Runtime: venv einrichten ─────────────────────────────────────────
...
# ─── Host-System: ydotool systemd-User-Service prüfen ────────────────────────
...
# ─── systemd-user: blitztext-linux.service einrichten ────────────────────────
install_app_service() {
